...
import com.roshan.popularmovies.utils.ImageUtils;
...
public final class GlideSetup implements GlideModule {
    ...
    @Override
    public void applyOptions(Context context, GlideBuilder builder) { /** ignore */}

    @Override
    public void registerComponents(Context context, Glide glide) {
        com.roshan.popularmovies.PopularMoviesApplication.get(context).inject(this);
