...
import com.roshan.popularmovies.utils.Lists;
...
public final class MovieFragment extends BaseFragment implements ObservableScrollViewCallbacks {
    ...
    private void trySetupToolbar() {
        if (getActivity() instanceof com.roshan.popularmovies.ui.activity.MovieDetailsActivity) {
            com.roshan.popularmovies.ui.activity.MovieDetailsActivity activity = ((com.roshan.popularmovies.ui.activity.MovieDetailsActivity) getActivity());
