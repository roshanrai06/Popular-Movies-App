 ...
 * corresponding methods called from another {@link RecyclerView.OnScrollListener} to
 * function. </p>
 *
...
public abstract class RecyclerViewPreloader<T> extends RecyclerView.OnScrollListener {
     ...
     * @deprecated Use {@link #RecyclerViewPreloader(RecyclerViewPreloader.PreloadModelProvider,
     * RecyclerViewPreloader.PreloadSizeProvider, int)} instead. This constructor will be removed in Glide
     * 4.0.
     */
    @Deprecated
    ...
    /**
     * Constructor for {@link RecyclerViewPreloader} that accepts interfaces for providing the dimensions of
     ...
     * parameters, gotten from {@link android.support.v7.widget.RecyclerView.LayoutManager}.
     *
     * @param firstVisible
     * @param visibleCount
     * @param totalCount
